...
namespace Genetic_Algorythm
{
    public partial class FrmGenetic : Form
    {
        ...
        {
            if (cmbItem.Text != "" && txtPopulationSize.Text != "" && txtGenerations.Text != "" && txtCrossOver.Text != "" && txtMutationProbalitiy.Text != "")
            {
        ...
        private void btnDone_Click(object sender, EventArgs e)
        {
            ...
            numberOfItems = Convert.ToInt32(cmbItem.Text);
            capacity = capacityTemplate[cmbItem.SelectedIndex];
            label16.Text = capacity.ToString();
            populationSize = Convert.ToInt32(txtPopulationSize.Text);
            numberOfGenerations = Convert.ToInt32(txtGenerations.Text);
            crossoverProbability = Convert.ToInt32(txtCrossOver.Text);
            mutationProbability = Convert.ToInt32(txtMutationProbalitiy.Text);
            currentGeneration = 0;
            ...
            {
                dataGrid.ColumnCount = numberOfItems;
                dataGrid.RowCount = populationSize;
                int rowNumber = 1;
            ...
            dataGrid2.ColumnCount = numberOfItems;
            ...
            dataGrid2.Rows[0].HeaderCell.Value = " Value";
            dataGrid2.Rows[1].HeaderCell.Value = "Weight";
            for (int i = 0; i < numberOfItems; i++)
            {
                dataGrid2[i, 0].Value = values[i];
                dataGrid2[i, 1].Value = weights[i];
            }
            ...
            dataGrid.Visible = !dataGrid.Visible;
            ...
            cmbItem.Visible = !cmbItem.Visible;
            txtPopulationSize.Visible = !txtPopulationSize.Visible;
            txtGenerations.Visible = !txtGenerations.Visible;
            txtCrossOver.Visible = !txtCrossOver.Visible;
            txtMutationProbalitiy.Visible = !txtMutationProbalitiy.Visible;
            btnDone.Visible = !btnDone.Visible;
            btnNextStep.Visible = !btnNextStep.Visible;
            btnFinal.Visible = !btnFinal.Visible;
        }
